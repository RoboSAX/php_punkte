...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 17. Mai 2019 um 10:43
...
INSERT INTO `games` (`gameid`, `block`, `time`, `points`, `objectives`, `penalties`, `team`, `active`, `finished`, `highlight`, `teamactive`) VALUES
...
(4, 'aihebfsjbfsje', 'sefsf', 0, 'sfesef', 0, 1),
(5, 'bhshkbef', 'sefsef', 0, 'sfesef', 0, 1),
(2, 'Ein unglaublich langer Name', 'awdaw', 0, 'Gieselheimer', 0, 1),
(1, 'Null pointer exception;', 'bl4', 0, 'Herr Heinz', 0, 1),
(3, 'Team 1', 'bl', 0, 'Herr Graus', 0, 1);
